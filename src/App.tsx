...
const AllRecommendationsPage = lazyLoad(
  () => import("./pages/AllRecommendationsPage"),
);
...
const TermsOfServicePage = lazyLoad(
...
function App() {
  // Create a component that uses the useRoutes hook within Router context
    ...
    <Router>
      <SidebarProvider>
        ...
        <Routes>
                ...
                <div className="flex flex-col space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mt-4">
                      Order your favorite meals from the best restaurants in
                      town. Fast delivery, great prices, and amazing food.
                    </p>
                  ...
                  <div className="w-full max-w-6xl mx-auto px-4">
                    ...
                    <div className="md:hidden overflow-x-auto pb-4 -mx-4 px-4">
                      <div className="flex gap-4">
                        <Link
                          to="/category/pizza"
                          className="w-20 flex flex-col items-start"
                        >
          ...
          />
          <Route
            path="/profile/special-occasions"
            element={
              <Layout>
