    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-[400px] bg-white p-8 flex flex-col justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-md flex items-center justify-center"
          >
            Sign in
            <svg
          ...
          <button
            type="button"
            className="w-full mt-4 border border-gray-300 text-gray-700 hover:bg-gray-50 py-2 px-4 rounded-md"
            onClick={() => navigate("/")}
          >
            Try Demo Account
          </button>
      ...
      <div className="hidden md:block flex-1 relative bg-black">
        <div className="absolute inset-0 flex flex-col justify-between p-8">
          {/* Header */}
          <div>
            <h1 className="text-2xl font-bold text-white mb-6">Bizibyte</h1>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="border border-white rounded-md px-4 py-2 flex items-center text-white hover:bg-white/10"
              >
                <svg
